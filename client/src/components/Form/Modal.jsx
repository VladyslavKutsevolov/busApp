...
export default function Modal({ show, closeModal }) {
  let openModal = `modal opacity-${
    show ? 1 : 0
  } pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center`;
  let ref = useRef(null);
        ...
        <div className="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
          ...
          <div className="modal-content py-4 text-left px-6">
            ...
            <div className="flex justify-between items-center pb-3">
              ...
              <div ref={ref} className="modal-close cursor-pointer z-50">
                <svg
