...
export default function Modal({ show, route, closeModal }) {
  return (
    <>
      <div
        ...
        <div className="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
          ...
          <div className="modal-content py-4 text-left px-6">
            ...
            <form>
              <div className="container mx-auto rounded px-8 pt-6 pb-8">
                ...
                <label className="block mb-3">
                  ...
                  <select className="shadow  border form-select block w-full mt-1">
                    <option></option>
            ...
            <div className="flex justify-end pt-2">
              <button className="px-4 bg-transparent p-3 rounded-lg cursor-pointer text-indigo-500 hover:bg-gray-100 hover:text-indigo-400 mr-2">
                Action
              </button>
              <button
                onClick={closeModal}
